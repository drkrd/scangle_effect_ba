...
plotmetsfl3 <- plotmetsfl3[, c("fl1","fl2","fl3"):=tstrsplit(meanang,"_",fixed=T),]
plotmetsfl3$fl1 <- as.numeric(plotmetsfl3$fl1)
plotmetsfl3$fl2 <- as.numeric(plotmetsfl3$fl2)
plotmetsfl3 <- plotmetsfl3[, fl2:= ifelse(is.na(fl2), fl1, fl2),]



plotmetsfl3 <- plotmetsfl3[, cl1:=ifelse(fl1>=0&fl1<10, "a",
                                         ifelse(fl1>=10&fl1<20, "b",
                                                ifelse(fl1>=20&fl1<30, "c",
                                                       ifelse(fl1>=30&fl1<40,"d","e"))))]
plotmetsfl3 <- plotmetsfl3[, cl2:=ifelse(fl2>=0&fl2<10, "a",
                                         ifelse(fl2>=10&fl2<20, "b",
                                                ifelse(fl2>=20&fl2<30, "c",
                                                       ifelse(fl2>=30&fl2<40,"d","e"))))]
plotmetsfl3 <- plotmetsfl3[, cl3:=ifelse(fl3>=0&fl3<10, "a",
...
plotmetsfl3 <- plotmetsfl3[cl1 != "e" & cl2 != "e" & cl3 != "e" & cl1 != "d" & cl2 != "d" & cl3 != "d",]
plotmetsfl3 <- plotmetsfl3[!fl1 %in% c(37.24, 7.16, 4.60, 16.52) & 
                             !fl2 %in% c(37.24, 7.16, 4.60, 16.52) & 
                             !fl3 %in% c(37.24, 7.16, 4.60, 16.52)]


plotmetsfl3 <- plotmetsfl3[, cl := paste0(sort(.SD), collapse = ""), .SDcols = c("cl1", "cl2", "cl3"),  by = 1:nrow(plotmetsfl3)]
...
allvoxfiles <- allvoxfiles[!fl1 %in% c(37.24, 7.16, 4.60, 16.52) & 
                             !fl2 %in% c(37.24, 7.16, 4.60, 16.52) & 
                             !fl3 %in% c(37.24, 7.16, 4.60, 16.52)]
allvoxfiles <- allvoxfiles[, fl3 := ifelse(fl3=="nil", fl2, fl3)]
...
setkeyv(plotmetsfl3, c("id_placette", "meanang"))
plotmetsfl3 <- plotmetsfl3[pfcvladvox]
#############################################################################################################################
